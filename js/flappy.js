...
function Barreiras(altura, largura, abertura, espaco, notificarPonto) {
  ...
  this.animar = () => {
    this.pares.forEach((par) => {
      ...
      const passouMeio = par.getX() + deslocacao >= meio && par.getX() < meio;
...
function colisao (passaro, barreiras){
    ...
    barreiras.pares.forEach(paresDeBarreiras =>{
        if(!colisao){
            const superior = paresDeBarreiras.superior.elemento
            const inferior = paresDeBarreiras.inferior.elemento
